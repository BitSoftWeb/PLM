...
<%--                                <f:DatePicker runat="server" DateFormatString="yyyy-MM-dd" Label="开始日期" LabelWidth="90" EmptyText="请选择开始日期"
                ...
                <f:Grid ID="GridGZ" IsFluid="true" CssClass="blockpanel" Title="设备故障数据" EnableCollapse="false" PageSize="15" ShowBorder="true" ShowHeader="true"
                    ...
                    DataKeyNames="ID,完成情况,设备编号,设备名称,故障描述,故障时间,解决故障时间,更换备件,问题描述,问题的可能影响,修理费用,报修人,维修人,部门名称,维修人数,维修工时,维修人员名单,原因分析,开始维修时间,解决方案及计划,解决故障根本问题的办法" OnPageIndexChange="GridGZ_PageIndexChange"  OnRowCommand="Grid1_RowCommand" OnRowDataBound="Grid1_RowDataBound" DataTextField="Name" 
                   >
                    ...
                    <Columns>
                        ...
                        <f:RenderField ColumnID="部门名称" DataField="部门名称" HeaderText="所属单位" Width="150" />
